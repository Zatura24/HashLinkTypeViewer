...
// Taken from: https://github.com/LiveSplit/LiveSplit/blob/master/LiveSplit/LiveSplit.Core/ComponentUtil/DeepPointer.cs
...
namespace WindowsFormsApp1
{
    ...
    public class DeepPointer
    {
        ...
        public bool DerefOffsets(Process process, out IntPtr ptr)
        {
            ...
            ptr = _offsets.Any() ? ptr + _offsets[_offsets.Count - 1] : ptr;
            return true;
        }
